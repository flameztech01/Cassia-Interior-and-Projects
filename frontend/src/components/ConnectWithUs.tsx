...
const ConnectWithUs = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`absolute inset-0 transition-opacity duration-1500 delay-600 ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 lg:gap-20 items-stretch">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1">
            ...
            >
              ...
              <div className="relative">
                ...
                >
                  <span className="text-[#f6ee99] text-xs sm:text-sm tracking-[0.3em] uppercase relative inline-block pl-10 sm:pl-12 before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-6 sm:before:w-8 before:h-px before:bg-[#2F7D76]/40">
                    Let's Connect
                  </span>
                </div>
                ...
                >
                  Tell us what you want to achieve. We'll respond with the best
                  approach, timeline, and finishing plan for your project.
                </p>
              </div>
                    ...
                    <div className="flex items-start gap-3 sm:gap-4 md:gap-5">
                      <div className="relative shrink-0">
                        ...
                        <div className="relative w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full bg-[#2F7D76]/20 flex items-center justify-center">
                          <span className="text-[#E6E08A] text-lg sm:text-xl md:text-2xl">
                            ✉️
                          </span>
                        </div>
                      </div>
              ...
              <div className="mt-8 sm:mt-10 md:mt-12">
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-5 items-stretch sm:items-center pt-2 sm:pt-3 md:pt-4">
                    ...
                    >
                      Chat on WhatsApp
                      <span className="inline-block ml-1 sm:ml-2 group-hover:translate-x-1 transition-transform">
                        →
                      </span>
                    </a>
                  </div>
              ...
              <div
                className={`absolute top-3 sm:top-4 md:top-6 right-3 sm:right-4 md:right-6 w-8 sm:w-10 md:w-12 h-8 sm:h-10 md:h-12 border-t border-r border-[#E6E08A]/30 transition-opacity duration-1000 delay-1800 ${
                  isVisible ? "opacity-50" : "opacity-0"
                }`}
              />
              <div
                className={`absolute bottom-3 sm:bottom-4 md:bottom-6 left-3 sm:left-4 md:left-6 w-8 sm:w-10 md:w-12 h-8 sm:h-10 md:h-12 border-b border-l border-[#2F7D76]/30 transition-opacity duration-1000 delay-1900 ${
                  isVisible ? "opacity-50" : "opacity-0"
                }`}
              />
            </div>
          ...
          <div className="lg:col-span-5 order-1 lg:order-2 relative min-h-[400px] sm:min-h-[500px] md:min-h-[600px] lg:min-h-[700px] flex items-center mb-8 lg:mb-0">
            <div className="relative w-full h-full">
              ...
              >
                <p className="text-white/40 text-[10px] sm:text-xs tracking-[0.2em] mb-1 sm:mb-2">
                  AVAILABLE FOR
                </p>
    ...
    >
      ...
      <div className="flex items-start gap-2 sm:gap-3 md:gap-4">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-white/30 text-[10px] sm:text-xs tracking-wide font-light truncate">
            {label}
          </p>
